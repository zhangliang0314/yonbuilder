...
import * as tabsactions from '@mdf/metaui-web/lib/redux/tabs';
import * as portalactions from '@mdf/metaui-web/lib/redux/portal';
...
export class CardControl extends React.Component {
  ...
  render () {
    ...
    const date = format.Format(new Date(), 'MM-dd')
    return (
