  ...
  switch (type) {
    ...
    case 'quarter':/* 本季度 */
      if (index == 0) {
        ...
        const monthStartDate = new Date(nowYear, nowMonth, 1);
        const monthEndDate = new Date(nowYear, quarter_start + 3, 1);
        const days = (monthEndDate - monthStartDate) / (1000 * 60 * 60 * 24);
        return self.Format(new Date(nowYear, nowMonth, days));
      }
    case 'year':/* 本年 */
      if (index == 0) {
        ...
        const monthStartDate = new Date(nowYear, 11, 1);
        const monthEndDate = new Date(nowYear, 11 + 1, 1);
        const days = (monthEndDate - monthStartDate) / (1000 * 60 * 60 * 24);
    ...
    case 'lastyear':/* 上年 */
      if (index == 0) {
        ...
        const monthStartDate = new Date(lastYear, 11, 1);
        const monthEndDate = new Date(lastYear, 11 + 1, 1);
        const days = (monthEndDate - monthStartDate) / (1000 * 60 * 60 * 24);
